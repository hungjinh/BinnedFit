...
class Gamma():
    ...
    def __init__(self, e_obs, v_spec_major, v_spec_minor=None, sigma_TF_intr=0.08, par_fid=None):
        '''
            e_obs : chain of observed ellipticity measured from image (1d np. array)
            v_spec_major : chain of v_spec measured from 2D spec info (1d np.array)
